...
"# = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =\n#\n";
  ...
  if ( $self->{_as} ) {
    push @{ $self->{_header} },
"# <seq id> <alignment start> <alignment end> <envelope start> <envelope end> <hmm name> <hmm start> <hmm end> <bit score> <E-value> <significance> <clan> <predicted_active_site_residues>";
...
#"# <seq id> <alignment start> <alignment end> <envelope start> <envelope end> <hmm acc> <hmm name> <type> <hmm start> <hmm end> <hmm length> <bit score> <E-value> <significance> <clan> <predicted_active_site_residues>";
    ...
    push @{ $self->{_header} },
"# <seq id> <alignment start> <alignment end> <envelope start> <envelope end> <hmm name> <hmm start> <hmm end> <bit score> <E-value> <significance> <clan>";
...
#
# Authors: Fabian Schreiber (fs\@ebi.ac.uk), Mateus Patricio (mateus\@ebi.ac.uk), Jaina Mistry (jm14\@sanger.ac.uk), 
#          John Tate (jt6\@sanger.ac.uk), Rob Finn (rdf\@sanger.ac.uk)
#
...
EOF_license
  ...
  unshift @{ $self->{_header} },
    "# treefam_scan.pl, $v run at " . scalar(localtime) . "\n#\n";
}
